...
//8. add(1, 2, 3) => add = curry(add) add(1, 2, 3) = add(1)(2)(3) = add(1)(2, 3) = ...
...
function deepEq(a, b, aStack, bStack){
  ...
  if(!areArrays){
    ...
    if(aCtor !== bCtor && !(typeof aCtor === 'function' && typeof bCtor === 'function' && aCtor instanceof aCtor && bCtor instanceof bCtor)&& ('constructor' in a && 'constructor' in b)) return false
  }
